...
export default class UpdateContentModel{
...
function fileType2EP(type){
    ...
    switch(type){
        case env.CT.CONTENT_TYPE_VIDEO:{
            return env.EP.EDIT_PARAM_CONTENT_VIDEO_UPDATE;
        }
        case env.CT.CONTENT_TYPE_VOICE:{
            return env.EP.EDIT_PARAM_CONTENT_VOICE_UPDATE;
        }
        case env.CT.CONTENT_TYPE_DOCUMENT:{
            return env.EP.EDIT_PARAM_CONTENT_DOCUMENT_UPDATE;
        }
    }
}